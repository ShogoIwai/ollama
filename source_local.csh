...
# source_cloud.csh unsets all four; leaving them set would make cloud mode ask
# for a tag the cloud endpoint does not have.
setenv ANTHROPIC_DEFAULT_SONNET_MODEL "$LOCALLLM_MODEL"
setenv ANTHROPIC_DEFAULT_OPUS_MODEL   "$LOCALLLM_MODEL"
setenv ANTHROPIC_DEFAULT_HAIKU_MODEL  "$LOCALLLM_MODEL"
setenv ANTHROPIC_SMALL_FAST_MODEL     "$LOCALLLM_MODEL"   # older name for the haiku slot
